...
### Document Management Endpoints (Phase 2 & 3)
...
| `GET` | `/api/v1/workspaces/<ws_id>/documents/<doc_id>/chunks/` | Inspect extracted text chunks | Member |
| `POST` | `/api/v1/workspaces/<ws_id>/documents/<doc_id>/reprocess/` | Re-trigger parsing & chunking | Admin / Manager |

### Vector Search & Embeddings Endpoints (Phase 4)

| Method | Endpoint | Description | Auth / Role Required |
|---|---|---|---|
| `POST` | `/api/v1/workspaces/<ws_id>/search/` | Semantic vector similarity search via pgvector cosine distance | Member |
| `POST` | `/api/v1/workspaces/<ws_id>/documents/<doc_id>/reembed/` | Asynchronously regenerate embeddings for document chunks | Admin / Manager |
...
## 5. PostgreSQL pgvector Setup

To enable vector embeddings in PostgreSQL:
...
## 6. Continuous Integration (CI) & Test Suite
