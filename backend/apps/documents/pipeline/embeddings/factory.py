...
class EmbeddingProviderFactory:
    ...
    def get_provider(
        ...
        Args:
            provider_name: 'openai', 'gemini', or 'mock'. Defaults to settings.EMBEDDING_PROVIDER.
            model_name: Model identifier (e.g. 'text-embedding-3-small'). Defaults to settings.EMBEDDING_MODEL_NAME.
        ...
        """
        selected_provider = (provider_name or getattr(settings, "EMBEDDING_PROVIDER", "openai")).lower()
        selected_model = model_name or getattr(settings, "EMBEDDING_MODEL_NAME", "text-embedding-3-small")
        selected_dimensions = dimensions or getattr(settings, "EMBEDDING_DIMENSIONS", 1536)
        ...
        if selected_provider == "openai":
            ...
            if gemini_model in ["text-embedding-004", "text-embedding-3-small", ""]:
